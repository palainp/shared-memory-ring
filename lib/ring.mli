...
module Rpc : sig
  ...
  val of_buf : buf:Bytes.t -> idx_size:int -> name:string -> sring
  ...
  val of_buf_no_init : buf:Bytes.t -> idx_size:int -> name:string -> sring
  ...
  module Front : sig
    ...
    val ack_responses : ('a,'b) t -> (Bytes.t -> unit) -> unit
  ...
  module Back : sig
    ...
    val ack_requests : ('a, 'b) t -> (Bytes.t -> unit) -> unit
